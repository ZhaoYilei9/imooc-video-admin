...
<input type="hidden" id="hdnContextPath" name="hdnContextPath" value="<%=request.getContextPath() %>"/>
 <input type="hidden" id="apiServer" name="apiServer" value="http://192.168.1.7:8081"/>
 <input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.1.7:8080/mvc"/>
